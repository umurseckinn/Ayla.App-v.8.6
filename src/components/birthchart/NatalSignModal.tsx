            ...
            <div 
              ...
              <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar touch-pan-y" style={{ WebkitOverflowScrolling: 'touch' }}>
                <div className="flex flex-col space-y-6 pb-2">
                  <div className="relative w-full h-24 sm:h-32 shrink-0 flex items-center justify-center">
                    <div className="absolute inset-0 bg-mystic-gold/10 rounded-full blur-3xl animate-pulse" />
                    
                    <motion.div 
                      initial={{ scale: 0.8, opacity: 0 }}
                      animate={{ scale: 1, opacity: 1 }}
                      className="relative z-10 w-20 h-20 sm:w-28 sm:h-28 flex items-center justify-center"
                    >
                      <ZodiacImage sign={signName} size={80} className="sm:w-28 sm:h-28 filter drop-shadow-[0_0_20px_rgba(212,175,55,0.4)]" />
                    </motion.div>
                  </div>
